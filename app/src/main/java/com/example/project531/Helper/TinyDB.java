...
public class TinyDB {
    ...
    public ArrayList<CourseDomain > getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<CourseDomain > playerList =  new ArrayList<CourseDomain >();

        for(String jObjString : objStrings){
            CourseDomain  player  = gson.fromJson(jObjString,  CourseDomain .class);
    ...
    public void putListObject(String key, ArrayList<CourseDomain > playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(CourseDomain  player: playerList){
